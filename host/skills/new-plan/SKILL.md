---
description: Create a new plan folder for ralph-once
---

# Create New Plan

Guide a user through creating a new plan folder with properly structured files. Plans live in `plans/<name>/` and are used by ralph-once to drive task implementation.
...
When running via ralph-once, you MUST output one of these promises before finishing:
